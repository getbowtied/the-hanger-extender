...
(function($) {
	...
	$.fn.iconPicker = function() {
		...
		function createPopup($button) {
			...
			$popup = $('<div class="icon-picker-container"><div class="icon-picker-control"></div><ul class="icon-picker-list"></ul><a href="#" class="icon-picker-close">Close</a></div>')
				.css({
			...
			$('.icon-picker-close').on( 'click', function(e) {
				e.preventDefault();
				removePopup();
			});
		}
