...
= 10.0.7 =
- Update Compatibility with WordPress 7.1.1
- Update Compatibility with WooCommerce 11.1.1
...
= 10.0 =
- Add fallback theme updater for older theme versions
...
= 4.3 =
- Update Compatibility with WordPress 7.0.0
- Update Compatibility with WooCommerce 10.8.1

= 4.2 =
- Update Compatibility with WordPress 6.9.4
- Update Compatibility with WooCommerce 10.6.1

= 4.1 =
- WooCommerce 10.4.3 compatibility updates
...
= 3.8 =
- Update Compatibility with WooCommerce 10.3.4

= 3.7 =
- Maintenance: Data Sanitization/Escaping

= 3.6 =
- Fix: In some configurations, the theme cannot be updated manually

= 3.5 =
- WordPress 6.8.3 compatibility updates
- WooCommerce 10.2.2 compatibility updates

= 3.3 =
- WooCommerce 9.8.5 compatibility updates

= 3.2 =
- WordPress 6.8.1 compatibility updates
- WooCommerce 9.8.4 compatibility updates
